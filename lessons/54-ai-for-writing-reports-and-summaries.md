...
Title: AI for Writing Reports and Summaries  
Audience: Beginners  
Difficulty: Introductory  
Estimated time: 8 to 10 minutes  
Mode: Interactive lesson  
Topic area: Communication and writing  
Prerequisites: 53-ai-for-writing-clear-instructions.md  
...
Today we are going to cover AI for Writing Reports and Summaries.
...
# Lesson: AI for Writing Reports and Summaries
...
Help me draft this content for AI for Writing Reports and Summaries. Keep it clear, concise, and suitable for a beginner audience.
...
Better prompt:
Draft this for AI for Writing Reports and Summaries. Target audience is [who], goal is [outcome], keep it [tone], and limit to [length].
...
- Read [55-ai-for-writing-proposals.md](55-ai-for-writing-proposals.md)
