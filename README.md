...
LearningAI is a structured curriculum of 90 lessons designed to teach AI concepts and practical skills to complete beginners. Each lesson is a portable markdown file that runs as an interactive guided session in ChatGPT, Claude, Gemini, or Copilot.
...
- **90 structured lessons** covering AI fundamentals, practical skills, and safety
...
After lesson 10, continue in numerical order or skip to topics that match your needs. All 90 lessons are available in [lessons/README.md](lessons/README.md).
...
- **LICENSE** — MIT license
- **lessons/** — all lesson files (01-90)
  - README.md — full lesson catalog and topic descriptions
  - 01-what-is-ai.md through 90-ai-for-technical-learning-without-a-technical-background.md — individual lesson files
...
This is an actively maintained learning library. The core curriculum (90 foundational and practical lessons) is complete and stable. The library is expanding with additional lesson tracks for specialized topics.
